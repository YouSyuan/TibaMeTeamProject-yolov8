...
def pre(images, model_path, c, device="cpu"):
...
if __name__ == "__main__":
    weight = "weights/obj_alldata.pt"
    model_path = "runs/detect/train9_all_data"
    images_list = glob.glob("H:/TibaMe_TeamProject/projects/yolov8/test/images/*")    
    txt_name = "預測1"
    conf = 0.8
    ...
    for n, img in enumerate(images_list):
        print(n,"=====", img, "================================================")
        correct, file_name, pre_name = pre(img, f"{model_path}/{weight}", conf, 0)
        total_samples += 1
